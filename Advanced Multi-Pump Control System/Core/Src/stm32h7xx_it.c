...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
// uart buffer to recive every coming byte on it  coming data on it
volatile uint8_t d_value;
//buffer to accumlate the coming chars on it .
uint8_t getBuffer[128];
//varible to keep track of the number of recived bytes from uart
uint8_t volatile countOfGetBuffer = 0;
//if the uart have data check the which data is it
volatile uint8_t usart1HaveNewData = 0;
/* USER CODE END PV */
