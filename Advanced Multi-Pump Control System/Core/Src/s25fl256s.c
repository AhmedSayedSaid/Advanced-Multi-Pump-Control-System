...
int32_t S25FL256S_GetFlashInfo(S25FL256S_Info_t *pInfo)
{
  ...
  pInfo->FlashSize = S25FL256S_FLASH_SIZE;
  pInfo->EraseSectorSize = S25FL256S_SECTOR_SIZE;
  pInfo->EraseSectorsNumber = (S25FL256S_FLASH_SIZE/S25FL256S_SECTOR_SIZE);
  pInfo->ProgPageSize = S25FL256S_PAGE_SIZE;
  pInfo->ProgPagesNumber = (S25FL256S_FLASH_SIZE/S25FL256S_PAGE_SIZE);
...
int32_t S25FL256S_WriteDisable(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode)
{
  ...
  s_command.InstructionMode   = QSPI_INSTRUCTION_1_LINE;
  s_command.Instruction       = S25FL256S_WRITE_DISABLE_CMD;
  s_command.AddressMode       = QSPI_ADDRESS_NONE;
  s_command.AlternateByteMode = QSPI_ALTERNATE_BYTES_NONE;
  s_command.DummyCycles       = 0;
  s_command.DataMode          = QSPI_DATA_NONE;
...
int32_t S25FL256S_PageProgram(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode, uint8_t *pData, uint32_t WriteAddr, uint32_t Size)
{
  ...
  switch(Mode)
  {
// !!this mode is temporary disabled due to 80MHz speed limit !!
  //  case S25FL256S_SPI_1I4O_MODE :              /* 1-1-4 program commands */
//    s_command.Instruction     = S25FL256S_QUAD_IN_FAST_PROG_4_BYTE_ADDR_CMD;
//    s_command.InstructionMode = QSPI_INSTRUCTION_1_LINE;
...
int32_t S25FL256S_AutoPollingMemReady(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode)
{
  ...
  s_config.Match              = 0;
  s_config.Mask               = S25FL256S_SR1_WIP;
  s_config.MatchMode          = QSPI_MATCH_MODE_AND;
  s_config.StatusBytesSize    = 1;
  s_config.Interval           = 0x10;
  s_config.AutomaticStop      = QSPI_AUTOMATIC_STOP_ENABLE;
...
int32_t S25FL256S_Enter4BytesAddressMode(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode)
{
  ...
  s_command.InstructionMode   = QSPI_INSTRUCTION_1_LINE;
  s_command.Instruction       = S25FL256S_READ_BANK_REG_CMD;
  s_command.AddressMode       = QSPI_ADDRESS_NONE;
  s_command.AlternateByteMode = QSPI_ALTERNATE_BYTES_NONE;
  s_command.DataMode          = QSPI_DATA_1_LINE;
  s_command.DummyCycles       = 0;
  ...
  s_command.Instruction = S25FL256S_WRITE_BANK_REG_CMD;
  MODIFY_REG(reg1, S25FL256S_BA_EXTADD, S25FL256S_BA_EXTADD);
...
int32_t S25FL256S_Enter4LinesDataMode(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode)
{
  ...
  /* Initialize the read config register command */
  s_command.InstructionMode   = QSPI_INSTRUCTION_1_LINE;
  ...
  MODIFY_REG(reg[1], 0x00, S25FL256S_CR1_QUAD);
...
int32_t S25FL256S_ReadSTR(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode, uint8_t *pData, uint32_t ReadAddr, uint32_t Size)
{
  ...
  switch(Mode)
  {
  case S25FL256S_SPI_1I2O_MODE :           /* 1-1-2 read commands */
    s_command.InstructionMode = QSPI_INSTRUCTION_1_LINE;
  ...
  case S25FL256S_SPI_2IO_MODE :           /* 1-2-2 read commands */
    s_command.InstructionMode = QSPI_INSTRUCTION_1_LINE;
    s_command.Instruction     = S25FL256S_DUAL_INOUT_FAST_READ_4_BYTE_ADDR_CMD;
    s_command.AddressMode     = QSPI_ADDRESS_2_LINES;
    s_command.DataMode        = QSPI_DATA_2_LINES;
    s_command.DummyCycles     = S25FL256S_DUMMY_CYCLES_READ_DUAL_INOUT;
    break;

  case S25FL256S_SPI_1I4O_MODE :           /* 1-1-4 read commands */
    s_command.InstructionMode = QSPI_INSTRUCTION_1_LINE;
  ...
  case S25FL256S_SPI_4IO_MODE :           /* 1-4-4 read commands */
    s_command.InstructionMode = QSPI_INSTRUCTION_1_LINE;
  ...
  default:
    s_command.InstructionMode = QSPI_INSTRUCTION_1_LINE;
    s_command.Instruction     = S25FL256S_FAST_READ_4_BYTE_ADDR_CMD;
    s_command.AddressMode     = QSPI_ADDRESS_1_LINE;
    s_command.DataMode        = QSPI_DATA_1_LINE;
    s_command.DummyCycles     = S25FL256S_DUMMY_CYCLES_READ;
    break;
...
int32_t S25FL256S_ResetMemory(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode)
{
  ...
  s_command.InstructionMode   = QSPI_INSTRUCTION_1_LINE;
  s_command.Instruction       = S25FL256S_SOFTWARE_RESET_CMD;
  s_command.AddressMode       = QSPI_ADDRESS_NONE;
  s_command.AlternateByteMode = QSPI_ALTERNATE_BYTES_NONE;
  s_command.DummyCycles       = 0;
  s_command.DataMode          = QSPI_DATA_NONE;
...
int32_t S25FL256S_ReadID(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode, uint8_t *ID)
{
  ...
  /* Initialize the read ID command */
  s_command.InstructionMode   = QSPI_INSTRUCTION_1_LINE;
  s_command.Instruction       = S25FL256S_READ_ID_CMD2;
  s_command.AddressMode       = QSPI_ADDRESS_NONE;
  s_command.AlternateByteMode = QSPI_ALTERNATE_BYTES_NONE;
  s_command.DataMode          = QSPI_DATA_1_LINE;
  s_command.NbData            = 3;
...
int32_t S25FL256S_ProgEraseSuspend(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode)
{
  ...
  /* Initialize the S25FL256S_PROG_ERASE_SUSPEND_CMD command */
  s_command.InstructionMode   = QSPI_INSTRUCTION_1_LINE;
  s_command.Instruction       = S25FL256S_PROG_ERASE_SUSPEND_CMD;
  s_command.AddressMode       = QSPI_ADDRESS_NONE;
  s_command.AlternateByteMode = QSPI_ALTERNATE_BYTES_NONE;
  s_command.DummyCycles       = 0;
  s_command.DataMode          = QSPI_DATA_NONE;
...
int32_t S25FL256S_ProgEraseResume(QSPI_HandleTypeDef *Ctx, S25FL256S_Interface_t Mode)
{
  ...
  /* Initialize the S25FL256S_PROG_ERASE_RESUME_CMD command */
  s_command.InstructionMode   = QSPI_INSTRUCTION_1_LINE;
  s_command.Instruction       = S25FL256S_PROG_ERASE_RESUME_CMD;
  s_command.AddressMode       = QSPI_ADDRESS_NONE;
  s_command.AlternateByteMode = QSPI_ALTERNATE_BYTES_NONE;
  s_command.DummyCycles       = 0;
  s_command.DataMode          = QSPI_DATA_NONE;
